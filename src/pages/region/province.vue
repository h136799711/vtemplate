...
<template>
  <div class="main-content by-banners padding-md-bottom padding-md-top">
    ...
    <el-button
      ...
      size="mini"
      icon="el-icon-back"
      @click="$router.replace('/admin/region/index')"
    >
      {{ $t('Back') }}
    </el-button>
    <el-button
...
export default {
  ...
  methods: {
    ...
    onSubregion (row) {
      this.$router.push({ path: '/admin/region/city/' + row.code })
    },
    submitEditForm () {
      this.loading = true
      let that = this
      regionApi.updateProvince(this.editForm, (resp) => {
        that.loading = false
    ...
    refresh () {
      ...
      this.loading = true
      let that = this
      this.queryForm.country_id = this.id
      regionApi.queryProvince(this.queryForm, (resp) => {
